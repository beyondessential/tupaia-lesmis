...
// const AdminDialog = styled(Dialog)`
//   max-width: 800px;
// `;
...
const FigureContainer = () => {
  ...
  return (
    <div style={divStyle}>
      <img src="/new_project_guide.png" alt="New project guide" style={imageStyle} />
    </div>
  );
};
...
export const EditModalComponent = ({
  ...
  return (
    <Dialog onClose={onDismiss} open={!!fields} maxWidth="md" disableBackdropClick>
          ...
          <>
            ...
            {displayUsedBy && (
              <UsedBy
                ...
                errorMessage={usedByErrorMessage}
              />
            )}
          </>
          <FigureContainer />
...
export const NewProjectModal = connect(
  mapStateToProps,
  mapDispatchToProps,
  mergeProps,
)(EditModalComponent);
