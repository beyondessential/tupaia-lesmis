...
--
-- Name: mv$refreshmaterializedviewfast(mvrefresh."mv$allconstants", text, text, text, text, text, smallint, boolean, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public."mv$refreshmaterializedviewfast"(pconst mvrefresh."mv$allconstants", powner text, pviewname text, ptablealias text, ptablename text, prowidcolumn text, ppgmviewbit smallint, poutertable boolean, pinneralias text, pinnerrowid text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $_X$
/* ---------------------------------------------------------------------------------------------------------------------------------
Routine Name: mv$refreshMaterializedViewFast
...
CREATE TRIGGER "trig$_answer" AFTER INSERT OR DELETE OR UPDATE ON public.answer FOR EACH ROW EXECUTE PROCEDURE mvrefresh."mv$insertmaterializedviewlogrow"();
...
CREATE TRIGGER "trig$_data_source" AFTER INSERT OR DELETE OR UPDATE ON public.data_source FOR EACH ROW EXECUTE PROCEDURE mvrefresh."mv$insertmaterializedviewlogrow"();
...
CREATE TRIGGER "trig$_entity" AFTER INSERT OR DELETE OR UPDATE ON public.entity FOR EACH ROW EXECUTE PROCEDURE mvrefresh."mv$insertmaterializedviewlogrow"();
...
CREATE TRIGGER "trig$_question" AFTER INSERT OR DELETE OR UPDATE ON public.question FOR EACH ROW EXECUTE PROCEDURE mvrefresh."mv$insertmaterializedviewlogrow"();
...
CREATE TRIGGER "trig$_survey" AFTER INSERT OR DELETE OR UPDATE ON public.survey FOR EACH ROW EXECUTE PROCEDURE mvrefresh."mv$insertmaterializedviewlogrow"();
...
CREATE TRIGGER "trig$_survey_response" AFTER INSERT OR DELETE OR UPDATE ON public.survey_response FOR EACH ROW EXECUTE PROCEDURE mvrefresh."mv$insertmaterializedviewlogrow"();
...
SELECT pg_catalog.setval('public.migrations_id_seq', 1300, true);
