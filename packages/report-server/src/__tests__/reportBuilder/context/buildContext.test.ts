...
describe('buildContext', () => {
  ...
  const ENTITIES = {
    test_hierarchy: [
      ...
      { id: 'ouId8', code: 'FJ_Village1', name: 'Fiji Village 1', type: 'village', attributes: {} },
      { id: 'ouId9', code: 'FJ_Village2', name: 'Fiji Village 2', type: 'village', attributes: {} },
      {
        id: 'ouId10',
        code: 'FJ_Ind1',
        name: 'Fiji Individual 1',
        type: 'individual',
        attributes: {},
      },
      {
