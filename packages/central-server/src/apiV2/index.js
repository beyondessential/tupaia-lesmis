...
import { CreateDataTable, DeleteDataTable, EditDataTable, GETDataTables } from './dataTables';
...
apiV2.post('/dataTables', useRouteHandler(CreateDataTable));
...
apiV2.put('/dataTables/:recordId', useRouteHandler(EditDataTable));
...
apiV2.delete('/dataTables/:recordId', useRouteHandler(DeleteDataTable));
