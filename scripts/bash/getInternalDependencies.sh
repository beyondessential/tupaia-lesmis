...
if [ -z ${package_path} ]; then
  echo "access-policy" "aggregator" "api-client" "auth" "database" "data-api" "data-broker" "dhis-api" "expression-parser" "indicators" "utils" "ui-components" "weather-api" "server-boilerplate"
  exit 0
fi
